...
<base href="/">
    ...
    <!-- Main Menu CSS -->
    <link rel="stylesheet" href="layout/css/meanmenu.min.css">
    <!-- nivo slider CSS -->
    <link rel="stylesheet" href="layout/vendor/slider/layout/css/nivo-slider.css" type="text/css" />
    <link rel="stylesheet" href="layout/vendor/slider/layout/css/preview.css" type="text/css" media="screen" />
    <!-- Datetime Picker Style CSS -->
    <link rel="stylesheet" href="layout/css/jquery.datetimepicker.css">
    <!-- Magic popup CSS -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-3">
                                <div class="logo-area">
                                    <a href="index.html"><img class="img-responsive" src="layout/img/logo.png" alt="logo"></a>
                                </div>
                            </div>
